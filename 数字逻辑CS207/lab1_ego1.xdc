...
set_property PACKAGE_PIN M4 [get_ports {sw1[3]}]
set_property PACKAGE_PIN P3 [get_ports {sw1[2]}]
set_property PACKAGE_PIN P2 [get_ports {sw1[1]}]
set_property PACKAGE_PIN R2 [get_ports {sw1[0]}]
